import { normaliz, denormaliz } from '../src'
...
describe('normaliz', () => {
  it('should normalize a payload', () => {
    ...
    expect(entities).toEqual({
      ...
      users: {
        1: { userId: 1, name: 'john', comments: '1 - 2' },
      ...
      comments: {
        '1 - 2': { id: 1, sub_id: 2, content: 'Blah' },
  ...
  it('should throw if the schema is not an array', () => {
    expect(() => normaliz({}, { schema: null })).toThrow()
  })

  it('should throw if the entity is not a string', () => {
    expect(() => normaliz({}, { schema: [], entity: null })).toThrow()
  })
})
...
describe('denormaliz', () => {
  ...
  it('should throw if the schema is not an array', () => {
    expect(() => denormaliz({}, { schema: null })).toThrow()
  })
})
